...
#um -y install wget git net-tools bind-utils iptables-services bridge-utils bash-completion httpd-tools kexec-tools sos psacct ansible
...
# OPTIONS=\"\$OPTIONS --insecure-registry 10.3.103.5:5000\"
