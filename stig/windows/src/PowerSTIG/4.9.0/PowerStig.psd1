...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = '* Update PowerSTIG to successfully parse/apply Microsoft Office 365 ProPlus STIG - Ver 2, Rel 2: [#887](https://github.com/microsoft/PowerStig/issues/887)
