...
# Possible Values: [custom azure/stack config scheme](https://docs.microsoft.com/en-us/azure-stack/user/azure-stack-version-profiles-azurecli2?view=azs-2002#connect-to-azure-stack-hub)
[string] $DepArgs.AzureCloud = "my-stack-config"

# custom Stack AzureDomain configuration - Stack Example: my-stack.domain.com
[string] $DepArgs.AzureDomain = "my-stack.domain.com"

# custom Stack configuration - Stack Example: 2018-03-01-hybrid
...
[int] $DepArgs.CnsGlusterDiskSize = 128 # $cnsGlusterDiskSize = "1024"
