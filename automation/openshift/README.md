...
* *Container orchestration*. Use the [secure OpenShift deployment](https://github.com/Azure/ato-toolkit/automation/openshift/ocp3.11/README.md) to deploy a functional OpenShift 3.11 cluster
